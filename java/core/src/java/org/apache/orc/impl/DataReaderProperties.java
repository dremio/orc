...
public final class DataReaderProperties {
  ...
  private final Reader.ZeroCopyPoolShim zeroCopyPoolShim;
  ...
  private DataReaderProperties(Builder builder) {
    ...
    this.zeroCopyPoolShim = builder.zeroCopyPoolShim;
  }
  ...
  public Reader.ZeroCopyPoolShim getZeroCopyPoolShim() {
  ...
  public static class Builder {
    ...
    private Reader.ZeroCopyPoolShim zeroCopyPoolShim;
    ...
    public Builder withZeroCopyPoolShim(Reader.ZeroCopyPoolShim value) {
